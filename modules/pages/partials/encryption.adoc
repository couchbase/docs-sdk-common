...
In Couchbase Data Platform 5.5 and up, AES-256, AES-128, and RSA are all supported.
...
For your preferred SDK, an API reference is available, linked from xref:hello-world:start-using-sdk.adoc[Install and Start Using the SDK with Couchbase Server] as well as xref:howtos:encrypting-using-sdk.adoc[sample code].
