...
For your preferred SDK, an API reference is available, linked from xref:howtos:start-using-sdk.adoc[Install and Start Using the Java SDK with Couchbase Server] as well as xref:howtos:encrypting-using-sdk.adoc[sample code].
