...
This Open Source https://github.com/couchbase/java-dcp-client[Java DCP client] is _not supported_ in production use (although the curious may wish to inspect the source, for fuller understanding of Couchbase internals).
