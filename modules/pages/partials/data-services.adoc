...
:page-aliases: choosing-the-right-service.adoc,http-services.adoc,data-services.adoc
...
From Couchbase Server 6.5, xref:7.1@server:n1ql:n1ql-language-reference/searchfun.adoc[Search Functions] allow the use of FTS _within_ N1QL queries.
