...
From Couchbase Server 6.5, the search service can be accessed by xref:7.1@server:n1ql:n1ql-language-reference/searchfun.adoc[search functions in {sqlpp}] (formerly N1QL).
