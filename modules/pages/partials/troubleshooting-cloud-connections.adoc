...
* That you are using a supported version of the {name-sdk} -- preferably the latest. All xref:{cert-link}[recent versions] of the {name-sdk} include the Capella cluster's Security Certificate.
