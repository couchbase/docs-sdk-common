...
* xref:howtos:observability-tracing.adoc[Request Tracing] -- The tracing capability allows the SDK to store, aggregate, and potentially forward information about an individual request which can be used for later analysis.
