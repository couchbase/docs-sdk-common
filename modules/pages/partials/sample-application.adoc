...
* https://github.com/couchbaselabs/try-cb-nodejs[Node.js^]
* https://github.com/couchbaselabs/try-cb-java[Java^]
* https://github.com/couchbaselabs/try-cb-dotnet[.NET^]
* https://github.com/couchbaselabs/try-cb-golang[Go^]
* https://github.com/couchbaselabs/try-cb-php[PHP^]
* https://github.com/couchbaselabs/try-cb-python[Python^]
* https://github.com/open-source-parsers/jsoncpp[C^]
...
See <<using-travel-app>> below for guidelines on how to use the travel app.
...
Download http://www.couchbase.com/download[Couchbase Server 4.5^]and install it.
...
The application serves an HTML file named [.path]_index.html_ (eg.
...
The Angular controller script named `script.js`, which you can find in the [.path]_/public/js/_ directory, controls how the application interacts with the REST API in the server application.

.The Application Services
image::{incimagesdir}/architecture-overview.png[,650px]
...
image::{incimagesdir}/angular-rest.png[,350px]

.REST API for finding airports
image::{incimagesdir}/architecture-airport.png[,650px]
...
image::{incimagesdir}/architecture-flight-path.png[,650px]
...
. Find a flight:
+
image::{incimagesdir}/travel-app-screen.png[,650px]
+
