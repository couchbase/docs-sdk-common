= Sample Application
:page-aliases: hello-world:sample-application
...
* xref:2.6@nodejs-sdk::sample-app-backend.adoc[Node.js]
* xref:2.7@java-sdk::sample-app-backend.adoc[Java]
* xref:2.7@dotnet-sdk::sample-app-backend.adoc[.NET]
* xref:2.5@python-sdk::sample-app-backend.adoc[Python]
* xref:2.6@php-sdk::sample-app-backend.adoc[PHP]
* xref:1.6@go-sdk::sample-app-backend.adoc[Go]
* xref:2.10@c-sdk::sample-app-backend.adoc[C/C++ (basic interaction with data model only)]
