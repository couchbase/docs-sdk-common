...
TIP: See the xref:{version-server}@server:learn:views/views-writing.adoc[Incremental MapReduce Views] and xref:7.1@server:learn:views/views-querying.adoc[Querying Data with Views] sections of the general documentation to learn more about views and their architecture.
// end::views-intro[]
