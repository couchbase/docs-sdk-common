...
TIP: See the xref:4.6@server:architecture:incremental-map-reduce-views.adoc[Incremental MapReduce Views] and xref:4.6@server:architecture:querying-data-with-views.adoc[Querying Data with Views] sections of the general documentation to learn more about views and their architecture.
--
// end::views-intro[]
