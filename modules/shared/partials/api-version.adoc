...
|===
| | API 3.2 | API 3.3 | API 3.4 | API 3.5 | API 3.61
...
*SDK API 3.5*: Introduced support for base 64 encoded vector types alongside Server 7.6.2 (and Capella). Binary transactions support in some SDKs.
