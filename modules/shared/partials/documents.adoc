...
A _document_ refers to an entry in the database (other databases may refer to the same concept as a xref:7.1@server:learn:data/document-data-model.adoc#couchbase-server-and-json-the-benefits[_row_]).
