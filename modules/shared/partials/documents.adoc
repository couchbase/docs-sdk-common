...
You are free to choose any ID for your document, so long as it conforms to the above restrictions.
Unlike some other database, Couchbase does not automatically generate IDs for you, though you may use a separate xref:#counters[counter] to increment a serial number.
