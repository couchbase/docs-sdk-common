...
// tag::intro[]
Couchbase Distributed xref:server:learn:data/transactions.adoc#overview[ACID (atomic, consistent, isolated, and durable)] Transactions allow applications to perform a series of database operations as a single unit -- meaning operations are either committed together or all undone.
...
* The xref:cxx-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[{cpp} SDK].
* The xref:dotnet-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[.NET SDK].
* The xref:go-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[Go SDK].
* The xref:java-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[Java SDK].
* The xref:kotlin-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[Kotlin SDK].
* The xref:nodejs-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[Node.js SDK].
* The xref:php-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[PHP SDK].
* The xref:python-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[Python SDK].
// * The xref:ruby-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[Ruby SDK].
* The xref:scala-sdk:howtos:distributed-acid-transactions-from-the-sdk.adoc[Scala SDK].
// end::other[]
