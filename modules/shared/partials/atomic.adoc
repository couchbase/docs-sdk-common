...
If you are using xref:{version-server}@server:manage:manage-xdcr/xdcr-management-overview.adoc[Cross Data Center Replication] (XDCR), be sure to avoid modifying the same counter in more than one datacenter.
