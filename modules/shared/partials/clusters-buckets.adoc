...
// tag::management[]
The primary means for managing clusters is through the xref:{version-server}@server:manage:manage-buckets/bucket-management-overview.adoc[Couchbase Web UI] which provides an easy to use interface for adding, removing, monitoring, and modifying buckets.
