...
More details on connecting your client code to the Couchbase Cloud can be found https://docs.couchbase.com/cloud/get-started/connect-to-cluster.html#locate-the-clusters-endpoints-and-built-in-sdk-examples[in the Cloud docs].
